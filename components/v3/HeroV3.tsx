...
// Two CTAs: primary terra button, secondary text link.

export default function HeroV3() {
  return (
    <section className="relative min-h-screen flex items-center bg-forest overflow-hidden">
      {/* Subtle texture blobs */}
      <div className="absolute top-0 right-0 w-[32rem] h-[32rem] rounded-full bg-forest-light/30 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full bg-terra/8 blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-32 pt-40 z-10 w-full">
        ...
        <p className="font-serif text-3xl md:text-4xl text-warm/90 mb-12 leading-snug">
          ...
          <em className="text-terra not-italic font-semibold">I can help.</em>
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="/apply"
            className="inline-flex items-center justify-center gap-2 bg-terra hover:bg-terra-dark text-white px-8 py-4 rounded-2xl text-lg font-medium font-dm-sans transition-all shadow-lg shadow-terra/20 hover:-translate-y-0.5"
          >
