// V2 ALTERNATE HERO
// Changes from v1:
//   - Headline rewritten to lead with concrete value proposition and named audience.
//   - Subheadline names specific operational pain points instead of abstract "root causes" framing.
//   - Badge copy updated to match audience language.
//   - CTA unified to "Schedule a Free Consult" (consistent with nav and contact section).
      ...
      <div className="relative max-w-5xl mx-auto px-6 py-24 pt-36 z-10 w-full">
        <div className="grid md:grid-cols-5 gap-12 items-center">
          ...
          <div className="md:col-span-3">
            ...
            {/* V2 headline: leads with concrete problem + audience instead of poetic framing */}
            <h1 className="font-serif text-4xl md:text-5xl text-warm leading-snug mb-6">
              I help youth-serving organizations fix the reporting, tracking, and program systems that keep{' '}
              <em className="text-sky-light not-italic">good work from showing up clearly.</em>
            </h1>

            {/* V2 subheadline: names the real operational problems readers recognize */}
            <p className="text-warm/65 text-lg max-w-xl mb-10 leading-relaxed">
              If your outcome data lives in too many spreadsheets, every grant deadline turns into a
              scramble, or enrollment is soft and you're not sure why, you probably don't have a
              performance problem. You have a systems problem. That's fixable.
            </p>
