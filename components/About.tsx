          ...
          <div className="md:col-span-3">
            ...
            <div className="space-y-5 text-navy/65 text-lg leading-relaxed">
              <p>
                ...
                like to be the person responsible for grant reports who also had to lead afterschool,
                supervise staff, manage community relationships, and keep the lights on.
              </p>
              <p>
                The consulting work I do now comes from that experience — not from a framework I
                read in a book, not from theory. I've built the systems I recommend. I've done the
                data pulls I'm asking you to simplify. I've had the conversations with funders that
                require you to actually know your numbers.
              </p>
              <p>
              ...
              <p>
                What I bring isn't a methodology. It's practitioner credibility, a systems-builder
                mindset, and enough distance from your day-to-day to see what you can't see when
                you're inside it.
              </p>
            </div>
          </div>
