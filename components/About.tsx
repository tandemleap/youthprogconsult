      ...
      <div className="max-w-5xl mx-auto">
        <div className="max-w-3xl">
          ...
          <div className="space-y-5 text-cream/75 text-lg leading-relaxed">
            <p>
              I ran SPARK — a youth program in Ashland, WI — for years. I know what it's
            ...
            <p>
              I work with organizations because I genuinely believe good youth programs are
              worth preserving — and too many of them are struggling with back-end systems
